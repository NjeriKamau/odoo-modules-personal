odoo.define('investors.dashboard', function (require) {
"use strict";
...
var HelpdeskDashboardRenderer = KanbanRenderer.extend({
    events: _.extend({}, KanbanRenderer.prototype.events, {
        ...
        'click .o_investor_activity': '_scheduleActivity',
    }),
    ...
    _scheduleActivity: function (user_id) {
        var action = {
    ...
    _render: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            var investor_dashboard = QWeb.render('investors.MyDashboard', {
                widget: self,
            ...
            self.$el.prepend(investor_dashboard);
        });
    },
...
var InvestorsDashboardView = KanbanView.extend({
...
view_registry.add('investors_dashboard', InvestorsDashboardView);
